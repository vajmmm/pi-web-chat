...
export const DEFAULT_PERMISSION_PROFILES: Record<string, PermissionProfile> = {
  "coordinator-readonly": {
    ...
    name: "统筹者调度权限 (开放权限)",
    description: "具备架构规划、任务拆分、代码读写与子智能体调度全量权限",
    allowedTools: [
      "read",
      "bash",
      "edit",
  ...
  "reviewer-readonly": {
    ...
    name: "审查者权限 (开放读写)",
    description: "代码审查与诊断权限，支持读写与命令执行",
  ...
  "frontend-standard": {
    ...
    name: "前端开发权限 (开放权限)",
    description: "前端开发权限，支持完整代码编写与命令执行",
    allowedTools: ["read", "bash", "edit", "write"],
    writableScope: "all",
    requiresWorktree: false,
  },
  "backend-standard": {
    id: "backend-standard",
    name: "后端开发权限 (开放权限)",
    description: "后端开发权限，支持完整代码编写与命令执行",
    allowedTools: ["read", "bash", "edit", "write"],
    writableScope: "all",
    requiresWorktree: false,
  },
  "fullstack-standard": {
    ...
    name: "全栈开发权限 (开放权限)",
    description: "全栈开发权限，支持端到端完整代码编写与命令执行",
    allowedTools: ["read", "bash", "edit", "write"],
    writableScope: "all",
    requiresWorktree: false,
  },
  "tester-test-write": {
    ...
    name: "测试者权限 (开放权限)",
    description: "测试开发权限，支持编写测试用例与测试执行",
    allowedTools: ["read", "bash", "edit", "write"],
    writableScope: "all",
    requiresWorktree: false,
  },
